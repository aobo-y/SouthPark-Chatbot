...
DROPOUT_INPUT_KEPP_PROB = 0.65 # [0, 1], input keep probability; if it is constant and 1, no input dropout will be added
DROPOUT_OUTPUT_KEEP_PROB = 0.5 # [0, 1], output keep probability; if it is constant and 1, no output dropout will be added
DROPOUT_STATE_KEPP_PROB = 0.55 # [0, 1], state dropout is performed on the outgoing states of the cell
